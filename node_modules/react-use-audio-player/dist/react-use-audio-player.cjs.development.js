    ...
    case ActionTypes.ON_MUTE:
      {
        ...
        return _extends({}, state, {
          muted: (_action$howl$mute = action.howl.mute()) != null ? _action$howl$mute : false
        });
      }
    case ActionTypes.ON_RATE:
      {
        ...
        return _extends({}, state, {
          rate: (_action$howl$rate = (_action$howl = action.howl) == null ? void 0 : _action$howl.rate()) != null ? _action$howl$rate : 1.0
        });
      }
    case ActionTypes.ON_VOLUME:
      {
        ...
        return _extends({}, state, {
          volume: (_action$howl$volume = (_action$howl2 = action.howl) == null ? void 0 : _action$howl2.volume()) != null ? _action$howl$volume : 1.0
        });
      }
...
function useHowlEventSync(howlManager, _ref) {
  ...
  var onError = react.useCallback(function (_, errorCode) {
    dispatch({
  ...
  var onStop = react.useCallback(function () {
    var howl = howlManager.getHowl();
    if (howl === undefined) return;
    dispatch({
  ...
  var onVolume = react.useCallback(function () {
    var howl = howlManager.getHowl();
    if (howl === undefined) return;
    dispatch({
  ...
  var onRate = react.useCallback(function () {
    var howl = howlManager.getHowl();
    if (howl === undefined) return;
    dispatch({
  ...
  react.useEffect(function () {
    return function () {
      ...
      howl == null || howl.off("loaderror", onError);
      howl == null || howl.off("playerror", onError);
      howl == null || howl.off("play", onPlay);
      howl == null || howl.off("pause", onPause);
      howl == null || howl.off("end", onEnd);
      howl == null || howl.off("stop", onStop);
      howl == null || howl.off("mute", onMute);
      howl == null || howl.off("volume", onVolume);
      howl == null || howl.off("rate", onRate);
    };
  }, []);
...
var HowlInstanceManager = /*#__PURE__*/function () {
  ...
  _proto.destroyHowl = function destroyHowl() {
    ...
    if (this.options.onload) {
      var _this$howl;
      (_this$howl = this.howl) == null || _this$howl.off("load", this.options.onload);
    }
    if (this.options.onend) {
      var _this$howl2;
      (_this$howl2 = this.howl) == null || _this$howl2.off("end", this.options.onend);
    }
    if (this.options.onplay) {
      var _this$howl3;
      (_this$howl3 = this.howl) == null || _this$howl3.off("play", this.options.onplay);
    }
    if (this.options.onpause) {
      var _this$howl4;
      (_this$howl4 = this.howl) == null || _this$howl4.off("pause", this.options.onpause);
    }
    if (this.options.onstop) {
      var _this$howl5;
      (_this$howl5 = this.howl) == null || _this$howl5.off("stop", this.options.onstop);
    }
    (_this$howl6 = this.howl) == null || _this$howl6.unload();
  };
...
var useAudioPlayer = function useAudioPlayer() {
  ...
  var getPosition = react.useCallback(function () {
    ...
    return (_howl$seek = howl.seek()) != null ? _howl$seek : 0;
  }, []);
  ...
  var cleanup = react.useCallback(function () {
    var _getHowlManager;
    (_getHowlManager = getHowlManager()) == null || _getHowlManager.destroyHowl();
  }, []);
  return _extends({}, state, {
    load: load,
    seek: seek,
...
exports.useGlobalAudioPlayer = useGlobalAudioPlayer;
